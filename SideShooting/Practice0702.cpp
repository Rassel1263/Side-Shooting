...
{
    Input::GetInstance().mousePos = D3DXVECTOR2(xPos, yPos);

    Input::GetInstance().SetMouse(MOUSE::LMOUSE, bLeftButtonDown);
    Input::GetInstance().SetMouse(MOUSE::RMOUSE, bRightButtonDown);
}
...
int main( HINSTANCE, HINSTANCE, LPWSTR, int )
{
    ...
    DXUTCreateWindow( L"Practice0702" );
